  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#FAFAF9] text-[#111827]">
      ...
      <main className="max-w-5xl mx-auto px-6 py-20 flex-1 flex flex-col items-center justify-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#E5E7EB] bg-white text-[#2563EB] text-xs font-semibold tracking-wide mb-8 uppercase">
          <Sparkles className="h-3.5 w-3.5" /> Analytics Platform Scaffolding
        </div>

        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-[#111827] mb-6 leading-tight max-w-3xl">
          Track and Group User <br />
          Interactions in Real-time.
        </h1>

        <p className="text-lg text-[#6B7280] max-w-2xl mb-12 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20 w-full max-w-md">
          <Link
            href="/demo"
            className="group flex-1 flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold rounded-xl shadow-sm hover:shadow transition-all"
          >
            Open Demo Website
          ...
          <Link
            href="/dashboard"
            className="flex-1 flex items-center justify-center gap-2.5 px-6 py-3.5 bg-white hover:bg-gray-50 border border-[#E5E7EB] text-[#111827] font-semibold rounded-xl transition-all shadow-sm"
          >
        ...
        <div className="w-full max-w-4xl border border-[#E5E7EB] rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="text-xs font-bold text-[#6B7280] tracking-widest uppercase mb-8">
            Reviewer Evaluation Flow
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex flex-col items-center p-5 rounded-xl bg-[#FAFAF9] border border-[#E5E7EB] relative">
            ...
            <div className="flex flex-col items-center p-5 rounded-xl bg-[#FAFAF9] border border-[#E5E7EB]">
